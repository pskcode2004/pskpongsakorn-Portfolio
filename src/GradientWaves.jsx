...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    const setSize = () => {
      ...
      // Prevent WebGL crash by strictly bounding the rendering buffer height
      // while letting CSS stretch the canvas visually to fill the large container.
      const renderH = Math.min(h, 800);
      renderer.setSize(w, renderH);
      canvas.style.width = '100%';
      canvas.style.height = '100%';
